...
extern EIF_TYPED_VALUE F994_10774(EIF_REFERENCE);
extern EIF_TYPED_VALUE F994_10775(EIF_REFERENCE);
...
RTOID (F994_10774)
EIF_TYPED_VALUE F994_10774 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 993, Current, 1, 0, 16399);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(993, Current, 16399);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F994_10775 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;

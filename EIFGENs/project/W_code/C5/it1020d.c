...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_1020[] = {
	...
	{EIF_NON_GENERIC(0x019D /*206*/), 16778, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 8401, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 16776, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_1020), 16777, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x019D /*206*/), 16780, 0},
...
void Init1020(void)
{
	...
	IDSC(desc_1020 + 32, 248, 1019);
	IDSC(desc_1020 + 34, 398, 1019);
	IDSC(desc_1020 + 37, 397, 1019);
}

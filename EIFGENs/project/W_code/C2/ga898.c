...
extern void F898_10231(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg1, 897, l_feature_name, 1, eif_new_type(919, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_indexed", EX_PRE);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7530, "is_indexed", arg1))(arg1)).it_b);
...
body:;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7608, "bytes_per_pixel", arg1))(arg1)).it_i4);
...
void F898_10231 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 897, Current, 0, 10230);
	RTSA(dtype);
	RTME(dtype, 0);

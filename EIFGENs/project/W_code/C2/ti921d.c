...
static const EIF_TYPE_INDEX egt_13_921 [] = {0xFF01,893,0xFFFF};
static const EIF_TYPE_INDEX egt_14_921 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_921[] = {
	...
	{EIF_GENERIC(egt_13_921), 14941, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_921), 14942, 0xFFFFFFFF},
};
void Init921(void)
{
	IDSC(desc_921, 0, 920);
	IDSC(desc_921 + 1, 1, 920);
	IDSC(desc_921 + 32, 514, 920);
}

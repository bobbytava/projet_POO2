...
extern void F911_10707(EIF_REFERENCE);
	...
	if (tb1) {
		...
		if (tb1) {
			...
			*(EIF_REFERENCE *)(Current + RTWA(8389, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
			...
			ur1 = RTCCL(tr2);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(8241, "queue_sound_infinite_loop", tr1))(tr1, ur1x);
		} else {
			RTHOOK(11);
...
void F911_10707 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 910, Current, 0, 0, 16312);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(910, Current, 16312);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8389, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);

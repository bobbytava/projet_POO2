...
extern EIF_TYPED_VALUE F910_9573(EIF_REFERENCE);
...
RTOID (F910_9573)
EIF_TYPED_VALUE F910_9573 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 15261);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(909, Current, 15261);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

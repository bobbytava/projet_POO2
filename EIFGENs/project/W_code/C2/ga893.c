...
#define uu4_1 uu4_1x.it_n4
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7224, 0x24000000, 1); /* template_hash */
	*(EIF_INTEGER_64 *)(Current + RTWA(7224, dtype)) = (EIF_INTEGER_64) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7225, 0x18000000, 1); /* difference */
...
EIF_TYPED_VALUE F893_9340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT64;
	r.it_i8 = *(EIF_INTEGER_64 *)(Current + RTWA(7224,Dtype(Current)));
	return r;
}

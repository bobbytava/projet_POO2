...
static const struct desc_info desc_901[] = {
	...
	{EIF_GENERIC(egt_13_901), 14375, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_14_901), 14977, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_901), 14987, 0xFFFFFFFF},
};
void Init901(void)
{
	IDSC(desc_901, 0, 900);
	IDSC(desc_901 + 1, 1, 900);
	IDSC(desc_901 + 32, 407, 900);
	IDSC(desc_901 + 42, 379, 900);
	IDSC(desc_901 + 46, 370, 900);
}

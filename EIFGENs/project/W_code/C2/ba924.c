...
extern void F924_9721(EIF_REFERENCE);
	...
	if (tb1) {
		...
		if (tb1) {
			...
			*(EIF_REFERENCE *)(Current + RTWA(7401, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
			...
			ur1 = RTCCL(tr2);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7758, "queue_sound_infinite_loop", tr1))(tr1, ur1x);
		} else {
			RTHOOK(11);
...
void F924_9721 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 923, Current, 0, 0, 15415);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7401, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);

...
extern void F900_9288(EIF_REFERENCE);
extern void F900_9291(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F900_9293(EIF_REFERENCE);
...
/* {GAME_EVENTS}.make */
void F900_9288 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 899, Current, 0, 0, 14952);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 14952);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8079, "clear_actions", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(1,2);
	{
	...
	
	{
		...
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A900_50, (EIF_POINTER)(0),7186, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr3);
...
void F900_9291 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 899, Current, 0, 1, 14953);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 14953);
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (arg1) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F900_9293 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;

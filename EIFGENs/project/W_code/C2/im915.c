...
extern EIF_TYPED_VALUE F915_9243(EIF_REFERENCE);
...
RTOID (F915_9243)
EIF_TYPED_VALUE F915_9243 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 914, Current, 0, 0, 14892);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(914, Current, 14892);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

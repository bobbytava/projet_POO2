...
extern EIF_TYPED_VALUE F1055_12116(EIF_REFERENCE);
extern void F1055_12117(EIF_REFERENCE);
extern void F1055_12118(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1055_12119(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1055_12120(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1055_12116 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1054, Current, 3, 0, 17768);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 17768);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc3)) {
		...
		up1 = tp1;
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5359, 879))(Current, up1x)).it_p);
		RTHOOK(4);
		RTDBGAL(Current, 2, 0xF8000409, 0, 0); /* loc2 */
		tr1 = RTLN(eif_new_type(1033, 0x01).id);
		up1 = loc1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(9049, Dtype(tr1)))(tr1, up1x);
		RTNHOOK(4,1);
		...
		if (tb1) {
			...
			if (tb1) {
				RTHOOK(8);
				RTDBGAA(Current, dtype, 9678, 0xF80003E9, 0); /* internal_surface */
				tr1 = RTLNSMART(RTWCT(9678, dtype, Dftype(Current)).id);
				ur1 = RTCCL(loc2);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(8652, Dtype(tr1)))(tr1, ur1x);
				RTNHOOK(8,1);
				RTAR(Current, tr1);
				*(EIF_REFERENCE *)(Current + RTWA(9678, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
				RTHOOK(9);
				RTDBGAL(Current, 0, 0xF80003E9, 0,0); /* Result */
				Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9675, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			} else {
				RTHOOK(10);
				...
				*(EIF_BOOLEAN *)(Current + RTWA(7345, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				...
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(8656, Dtype(tr1)))(tr1, ur1x, ui4_1x, ui4_2x);
				RTNHOOK(12,1);
...
void F1055_12117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1054, Current, 1, 0, 17769);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 17769);
	RTIV(Current, RTAL);
...
body:;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(9634, dtype));
	up1 = tp1;
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5360, 879))(Current, up1x)).it_i4);
	RTHOOK(4);
	ui4_1 = loc1;
...
void F1055_12118 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1054, Current, 0, 4, 17770);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1054, Current, 17770);
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
	...
	*((EIF_REFERENCE *)tr3+0) = (EIF_REFERENCE) tr4;
	...
	RTNHOOK(1,1);
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9677, Dtype(Current)))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1055_12119 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_4 ui4_4x.it_i4
	...
	RTEAA(l_feature_name, 1054, Current, 6, 1, 17771);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 17771);
	{
		...
		RTCC(arg1, 1054, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	loc3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5524, 879))(Current)).it_i4);
	RTHOOK(3);
	RTDBGAL(Current, 1, 0x40000000, 1, 0); /* loc1 */
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1758, "count", arg1))(arg1)).it_i4);
	ui4_1 = ti4_1;
	loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5361, 879))(Current, up1x, up2x, ui4_1x)).it_i4);
	RTHOOK(15);
	ui4_1 = loc4;
...
EIF_TYPED_VALUE F1055_12120 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;

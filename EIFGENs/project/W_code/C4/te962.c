...
extern EIF_TYPED_VALUE F962_10687(EIF_REFERENCE);
...
RTOID (F962_10687)
EIF_TYPED_VALUE F962_10687 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 16353);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 16353);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

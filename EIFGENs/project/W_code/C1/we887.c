...
extern EIF_TYPED_VALUE F887_8873(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8874(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8875(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8876(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8877(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8878(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8879(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_8880(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F887_8873 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 14554);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(886, Current, 14554);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F887_8874 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 14555);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(886, Current, 14555);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F887_8875 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 14556);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(886, Current, 14556);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F887_8876 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F887_8877 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 14558);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(886, Current, 14558);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F887_8878 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 14559);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(886, Current, 14559);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F887_8879 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 14560);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(886, Current, 14560);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F887_8880 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 886, Current, 0, 1, 14561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(886, Current, 14561);
	RTIV(Current, RTAL);
	RTHOOK(1);

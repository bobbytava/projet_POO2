...
extern void F862_6969(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F862_6969 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_n1
	...
	RTEAA(l_feature_name, 861, Current, 0, 1, 12655);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 4908, 0x30000000, 1); /* state */
	*(EIF_NATURAL_8 *)(Current + RTWA(4908, Dtype(Current))) = (EIF_NATURAL_8) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F862_6970 (EIF_REFERENCE Current)
{
	...
	tu1_1 = *(EIF_NATURAL_8 *)(Current + RTWA(4908, Dtype(Current)));
...
EIF_TYPED_VALUE F862_6979 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT8;
	r.it_n1 = *(EIF_NATURAL_8 *)(Current + RTWA(4908,Dtype(Current)));
	return r;
}

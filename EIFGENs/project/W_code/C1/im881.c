...
extern void F881_9065(EIF_REFERENCE);
extern void F881_9066(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F881_9067(EIF_REFERENCE);
extern void F881_9068(EIF_REFERENCE);
extern void F881_9069(EIF_REFERENCE);
extern EIF_TYPED_VALUE F881_9070(EIF_REFERENCE);
extern EIF_TYPED_VALUE F881_9071(EIF_REFERENCE);
extern EIF_TYPED_VALUE F881_9072(EIF_REFERENCE);
extern void F881_9073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F881_9074(EIF_REFERENCE);
extern void F881_10090(EIF_REFERENCE, int);
...
void F881_9065 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(880, Current, 14744);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6976, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(1,2);
...
void F881_9066 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 880, Current, 1, 3, 14745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tb1 = '\01';
	if (arg3) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6974, dtype))(Current)).it_b);
		tb1 = tb2;
	}
	ub1 = tb1;
...
void F881_9067 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(880, Current, 14746);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
	ub2 = (EIF_BOOLEAN) 0;
	ub3 = (EIF_BOOLEAN) 0;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6968, dtype))(Current, ub1x, ub2x, ub3x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("png_is_enabled", EX_POST);
		tb1 = '\01';
...
void F881_9068 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(880, Current, 14747);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 0;
	ub2 = (EIF_BOOLEAN) 1;
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F881_9070 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 880, Current, 1, 0, 14749);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(880, Current, 14749);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
...
EIF_TYPED_VALUE F881_9071 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 880, Current, 1, 0, 14750);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(880, Current, 14750);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	ui4_1 = ((EIF_INTEGER_32) 0L);
...
EIF_TYPED_VALUE F881_9072 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 880, Current, 1, 0, 14751);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F881_9073 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14752);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14753);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F881_10090 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 880, Current, 0, 10089);
	RTSA(dtype);
	RTME(dtype, 0);

...
extern void F892_8919(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F892_12795(EIF_REFERENCE, int);
...
void F892_8919 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 891, Current, 0, 1, 14598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(891, Current, 14598);
	RTCC(arg1, 891, l_feature_name, 1, eif_new_type(894, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6849, 0xF800037E, 0); /* process_launcher */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6849, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F892_8920 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(6845,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F892_8921 (EIF_REFERENCE Current)
{
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6847, Dtype(Current)))(Current)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F892_8924 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6849,Dtype(Current)));
	return r;
}
...
void F892_12795 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 891, Current, 0, 12794);
	RTSA(dtype);
	RTME(dtype, 0);

...
extern void F890_8726(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F890_8727(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F890_8728(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F890_8729(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F890_8725 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 889, Current, 0, 0, 14393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(889, Current, 14393);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6629, 0x04000000, 1); /* is_manual_error */
	*(EIF_BOOLEAN *)(Current + RTWA(6629, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F890_8726 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 889, Current, 0, 2, 14394);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(889, Current, 14394);
	RTCC(arg2, 889, l_feature_name, 2, eif_new_type(217, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F890_8727 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 889, Current, 0, 2, 14395);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F890_8728 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 889, Current, 0, 2, 14396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F890_8729 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 889, Current, 0, 2, 14397);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(889, Current, 14397);
	RTCC(arg1, 889, l_feature_name, 1, eif_new_type(217, 0x01), 0x01);
	RTCC(arg2, 889, l_feature_name, 2, eif_new_type(217, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6629, 0x04000000, 1); /* is_manual_error */
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 889, Current, 1, 0, 14399);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;

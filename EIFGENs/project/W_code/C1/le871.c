...
extern void F871_8615(EIF_REFERENCE);
extern void F871_8616(EIF_REFERENCE);
extern void F871_8617(EIF_REFERENCE);
extern EIF_TYPED_VALUE F871_8618(EIF_REFERENCE);
...
/* {LEVEL}.make_lvl1 */
void F871_8615 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 870, Current, 2, 0, 14298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(870, Current, 14298);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6545, 0xF80001AE, 0); /* array_balls */
	tr1 = RTLNSMART(RTWCT(6545, dtype, Dftype(Current)).id);
...
/* {LEVEL}.make_lvl2 */
void F871_8616 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 870, Current, 2, 0, 14299);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(870, Current, 14299);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80003B3, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(947, 0x01).id);
...
/* {LEVEL}.make_lvl3 */
void F871_8617 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 870, Current, 3, 0, 14300);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(870, Current, 14300);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80003B3, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(947, 0x01).id);
...
/* {LEVEL}.array_balls */
EIF_TYPED_VALUE F871_8618 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;

...
extern void F868_8590(EIF_REFERENCE);
extern void F868_8591(EIF_REFERENCE);
extern void F868_8592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F868_8593(EIF_REFERENCE);
...
/* {LEVEL}.make_lvl1 */
void F868_8590 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_lvl1";
	RTEX;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 867, Current, 2, 0, 14271);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 14271);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6522, 0xF80001AE, 0); /* array_balls */
	tr1 = RTLNSMART(RTWCT(6522, dtype, Dftype(Current)).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(2550, Dtype(tr1)))(tr1);
	RTNHOOK(3,1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6522, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(4);
...
/* {LEVEL}.make_lvl2 */
void F868_8591 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_lvl2";
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
	EIF_TYPED_VALUE up1x = {{0}, SK_POINTER};
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 867, Current, 2, 0, 14272);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 14272);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800039E, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(926, 0x01).id);
...
/* {LEVEL}.make_lvl3 */
void F868_8592 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "make_lvl3";
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 867, Current, 3, 0, 14273);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 14273);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800039E, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(926, 0x01).id);
...
/* {LEVEL}.array_balls */
EIF_TYPED_VALUE F868_8593 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;

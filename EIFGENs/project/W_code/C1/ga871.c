...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg1, 870, l_feature_name, 1, eif_new_type(924, 0x01), 0x01);
	RTCC(arg2, 870, l_feature_name, 2, eif_new_type(909, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6406, dtype))(Current);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6421, 0x10000000, 1); /* index */
	tp1 = *(EIF_POINTER *)(arg1 + RTVA(7852, "item", arg1));
	up1 = tp1;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6421, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6422, 0xF800039C, 0); /* haptic */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6422, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6423, 0xF800038D, 0); /* effect */
	RTAR(Current, arg2);
...
body:;
	...
	RTNHOOK(2,1);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7851, "remove_compiled_effect", tr1))(tr1, ur1x);
	RTHOOK(3);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6422, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	tp1 = *(EIF_POINTER *)(tr1 + RTVA(7852, "item", tr1));
	up1 = tp1;
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6421, dtype));
	ui4_1 = ti4_1;
...
#define ui4_1 ui4_1x.it_i4
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6422, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(2,1);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7827, "is_status_query_supported", tr1))(tr1)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:

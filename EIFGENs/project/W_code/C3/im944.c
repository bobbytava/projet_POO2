...
extern void F944_10135(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F944_10150(EIF_REFERENCE);
extern EIF_TYPED_VALUE F944_10151(EIF_REFERENCE);
extern void F944_10152(EIF_REFERENCE);
...
/* {IMG_IMAGE_FILE}.make */
void F944_10135 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 943, Current, 2, 1, 15872);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 15872);
	RTCC(arg1, 943, l_feature_name, 1, eif_new_type(217, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7937, 0x40000000, 1); /* rwop */
	...
	*(EIF_POINTER *)(Current + RTWA(7937, dtype)) = (EIF_POINTER) tp1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
#define up1 up1x.it_p
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(7937, Dtype(Current)));
	up1 = tp1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15857);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15858);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15859);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(943, Current, 15859);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tp1 = *(EIF_POINTER *)(Current + RTWA(7937, Dtype(Current)));
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15861);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15862);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15864);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15865);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(943, Current, 15865);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tp1 = *(EIF_POINTER *)(Current + RTWA(7937, Dtype(Current)));
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15866);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(943, Current, 15866);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tp1 = *(EIF_POINTER *)(Current + RTWA(7937, Dtype(Current)));
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15867);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F944_10149 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15868);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tp1 = *(EIF_POINTER *)(Current + RTWA(7937, dtype));
	tb2 = !tp1;
	if ((EIF_BOOLEAN) !tb2) {
		tb2 = '\01';
		tb3 = '\01';
		...
		tb12 = '\01';
		tb13 = '\01';
		tb14 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7924, dtype))(Current)).it_b);
		if (!tb14) {
			tb14 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7925, dtype))(Current)).it_b);
			tb13 = tb14;
		}
		if (!tb13) {
			tb13 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7926, dtype))(Current)).it_b);
			tb12 = tb13;
		}
		if (!tb12) {
			tb12 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7927, dtype))(Current)).it_b);
			tb11 = tb12;
		}
		if (!tb11) {
			tb11 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7928, dtype))(Current)).it_b);
			tb10 = tb11;
		}
		if (!tb10) {
			tb10 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7929, dtype))(Current)).it_b);
			tb9 = tb10;
		}
		if (!tb9) {
			tb9 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7930, dtype))(Current)).it_b);
			tb8 = tb9;
		}
		if (!tb8) {
			tb8 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7931, dtype))(Current)).it_b);
			tb7 = tb8;
		}
		if (!tb7) {
			tb7 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7932, dtype))(Current)).it_b);
			tb6 = tb7;
		}
		if (!tb6) {
			tb6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7933, dtype))(Current)).it_b);
			tb5 = tb6;
		}
		if (!tb5) {
			tb5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7934, dtype))(Current)).it_b);
			tb4 = tb5;
		}
		if (!tb4) {
			tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7935, dtype))(Current)).it_b);
			tb3 = tb4;
		}
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7936, dtype))(Current)).it_b);
			tb2 = tb3;
		}
		tb1 = tb2;
	}
...
/* {IMG_IMAGE_FILE}.open */
void F944_10150 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 943, Current, 1, 0, 15869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F944_10151 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_POINTER;
	r.it_p = *(EIF_POINTER *)(Current + RTWA(7937,Dtype(Current)));
	return r;
}


/* {IMG_IMAGE_FILE}.dispose */
void F944_10152 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 15871);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2659, 942))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;

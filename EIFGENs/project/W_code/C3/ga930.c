...
#define uu1_4 uu1_4x.it_n1
	...
	RTEAA(l_feature_name, 929, Current, 6, 3, 15520);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(929, Current, 15520);
	RTCC(arg1, 929, l_feature_name, 1, eif_new_type(881, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	loc6 = *(EIF_INTEGER_32 *)(Current + RTWA(7684, dtype));
	...
	uu1_4 = tu1_4;
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5159, 869))(Current, up1x, uu1_1x, uu1_2x, uu1_3x, uu1_4x)).it_n4);
	RTHOOK(6);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7689, dtype));

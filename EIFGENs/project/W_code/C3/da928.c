...
extern EIF_TYPED_VALUE F928_9359(EIF_REFERENCE);
extern EIF_TYPED_VALUE F928_9360(EIF_REFERENCE);
extern EIF_TYPED_VALUE F928_9361(EIF_REFERENCE);
...
EIF_TYPED_VALUE F928_9359 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F928_9360 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F928_9361 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 927, Current, 0, 0, 14993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(927, Current, 14993);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(7191, "fractional_second", tr1));

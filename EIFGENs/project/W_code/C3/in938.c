...
extern EIF_TYPED_VALUE F938_9406(EIF_REFERENCE);
extern EIF_TYPED_VALUE F938_9407(EIF_REFERENCE);
extern EIF_TYPED_VALUE F938_9408(EIF_REFERENCE);
extern void F938_9409(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F938_9406 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 937, Current, 1, 0, 15035);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(937, Current, 15035);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7276, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F938_9407)
EIF_TYPED_VALUE F938_9407 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 937, Current, 0, 0, 15036);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(937, Current, 15036);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F938_9408)
EIF_TYPED_VALUE F938_9408 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 937, Current, 0, 0, 15037);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(937, Current, 15037);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003AC, 0,0); /* Result */
...
void F938_9409 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 937, Current, 0, 1, 15038);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(937, Current, 15038);
...
{
	GTCX
	RTOTS (9407,F938_9407)
	RTOTS (9408,F938_9408)
}

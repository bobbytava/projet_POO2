...
static const EIF_TYPE_INDEX egt_13_940 [] = {0xFF01,220,0xFFFF};
static const EIF_TYPE_INDEX egt_14_940 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_940[] = {
	...
	{EIF_GENERIC(egt_13_940), 15039, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15040, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01 /*0*/), 15041, 0},
	{EIF_GENERIC(egt_14_940), 15042, 0xFFFFFFFF},
...
void Init940(void)
{
	...
	IDSC(desc_940 + 32, 361, 939);
	IDSC(desc_940 + 33, 399, 939);
	IDSC(desc_940 + 36, 397, 939);
}
